...
<head>
    <meta charset="utf-8">
    <title>/home/ubuntu/base-domain-loopback/node_modules/base-domain/src/lib/base-factory.coffee - base-domain-loopback</title>
    ...
    <div id="api-tabview" class="tabview">
        ...
        <label for="api-show-deprecated">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
                        <h1 class="file-heading">File: /home/ubuntu/base-domain-loopback/node_modules/base-domain/src/lib/base-factory.coffee</h1>
