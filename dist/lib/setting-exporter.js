...
SettingExporter = (function() {
  ...
  SettingExporter.prototype["export"] = function() {
    var EntityModel, EntityRepository, definition, definitions, e, i, len, modelName, name, ref;
    definitions = {};
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      definitions[modelName] = new ModelDefinition(EntityModel, EntityRepository, this.facade);
    }
  ...
  SettingExporter.prototype.setHasManyRelations = function(definitions) {
    var definition, modelName, prop, relModelDefinition, relModelName, results, typeInfo;
    results = [];
    for (modelName in definitions) {
      ...
      results.push((function() {
        ...
        for (prop in ref) {
          ...
          results1.push(relModelDefinition != null ? relModelDefinition.setHasManyRelation(modelName, typeInfo.idPropName) : void 0);
        }
        return results1;
      })());
    }
