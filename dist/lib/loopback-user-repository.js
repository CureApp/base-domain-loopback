...
LoopbackUserRepository = (function(superClass) {
  ...
  function LoopbackUserRepository(options, root) {
    ...
    this.client = this.getFacade().lbPromised.createUserClient(modelName, options);
  }
  ...
  LoopbackUserRepository.prototype.logout = function(sessionId) {
    ...
    client = this.getFacade().lbPromised.createUserClient(this.constructor.modelName, {
  ...
  LoopbackUserRepository.prototype.save = function(entity) {
    var password;
    password = entity != null ? entity.password : void 0;
    return LoopbackUserRepository.__super__.save.call(this, entity).then((function(_this) {
      return function(result) {
