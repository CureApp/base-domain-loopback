...
LoopbackRepository = (function(superClass) {
  ...
  LoopbackRepository.prototype.createFromQueryResults = function(params, objs, options) {
    var i, len, newProp, obj, prop, ref1, ref2, results;
    if (params == null) {
      params = {};
    }
    if (objs == null) {
    ...
    if ((((ref1 = params.include) != null ? ref1.relation : void 0) == null) || (((ref2 = params.include) != null ? ref2.as : void 0) == null)) {
      return LoopbackRepository.__super__.createFromQueryResults.apply(this, arguments);
    }
    ...
    for (i = 0, len = objs.length; i < len; i++) {
      ...
      delete obj[prop];
      results.push(this.createFromResult(obj, options));
    }
    return results;
  };
  ...
  LoopbackRepository.prototype.getRelatedClient = function(params) {
    ...
    try {
      Repo = this.getFacade().require(model + '-repository');
    ...
    return this.relClients[clientKey] = this.getFacade().lbPromised.createRelatedClient(relClientOptions);
  };
