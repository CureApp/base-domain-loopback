...
LoopbackRepository = (function(superClass) {
  ...
  LoopbackRepository.prototype.getRelatedClient = function(params) {
    var Repo, client, e, foreignKey, id, keyThrough, model, name, relClientOptions, relName, through;
    if (params == null) {
      params = {};
    }
    ...
    if (client = this.relClients[relName]) {
      client.setId(id);
      return client;
    }
    try {
    ...
    return this.relClients[relName] = this.getFacade().lbPromised.createRelatedClient(relClientOptions);
  };
